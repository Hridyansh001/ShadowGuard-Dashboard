...
export default function ThreatChart({ alerts }) {
  ...
  const innerRadius = isMobile ? 65 : 58

  return (
    <div style={{ ...styles.card, minHeight: isMobile ? 'auto' : '400px' }}>
      <div style={styles.header}>
        <span style={styles.title}>Threat Distribution</span>
        <span style={styles.count}>{chartData.length} categories</span>
      </div>

      <div style={{ height: chartHeight, minHeight: chartHeight, position: 'relative', flexShrink: 0 }}>
